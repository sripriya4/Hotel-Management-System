...
<head>
    ...
    <style>
		...
		body
		{
			background-image: url('images/home_bggg.jpg');
...
<body>
    <div class="container">
       ...
       <img class="img-responsive" src="images/hotel_bannerrr.jpg" style="width:100%; height:150px;">      
        ...
        <div class="w3-content w3-section">
            <img class="mySlides w3-animate-fading" src="images/home_gallary/entrance.jpg" style="width:100%; height:450px;">
            <img class="mySlides w3-animate-fading" src="images/home_gallary/entrance2.jpg" style="width:100%; height:450px;">
            <img class="mySlides w3-animate-fading" src="images/home_gallary/hotel_recep.jpg" style="width:100%; height:450px;">
            <img class="mySlides w3-animate-fading" src="images/home_gallary/hotel_swimming.jpg" style="width:100%; height:450px;">
        ...
        <div class="row" style="color: whitesmoke;">
            <div class="col-md-4 wellfix">
              ...
              <h5> Address : Raipur Chhattisgarh<br><br>
              Mail : rohanpranavgajeelee04@gmail.com <br><br> 
              Mail : sripriyar2001@gmail.com<br></h5>
              
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4 wellfix">
                <h4><strong style="color:#ffbb2b">Developed By</strong></h4><hr>
                <h5 style="color:whitesmoke;">Name: Sripriya R <br> Usn 1BY19CS158 <br><br>Name: Gajeelee Rohan Pranav <br> Usn: 1BY19CS194</h5>
            </div>
        </div>
