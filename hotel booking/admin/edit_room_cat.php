...
<body>
    <div class="container">
        <div class="well">
            <h2 style="color: black";>Add Room Category</h2>
            <hr>
            <form action="" method="post" name="room_category">
                <div class="form-group">
                    <label for="roomname" style="color: black";>Room Type Name:</label>
                    <input type="text" class="form-control" name="roomname" value="<?php echo $row['roomname'] ?>" required>
                </div>
                 <div class="form-group">
                    <label for="qty" style="color: black";>No of Rooms:</label>&nbsp;
                ...
                <div class="form-group">
                    <label for="bed" style="color: black";>No of Bed:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <select name="no_bed">
                ...
                <div class="form-group">
                    <label for="bedtype" style="color: black"; >Bed Type:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <select name="bedtype">
                ...
                <div class="form-group">
                    <label for="Facility" style="color: black";>Facility</label>
                    <textarea class="form-control" rows="5" name="facility"><?php echo $row['facility'] ?></textarea>
                </div>
               <div class="form-group">
                    <label for="price" style="color: black";>Price Per Night:</label>
